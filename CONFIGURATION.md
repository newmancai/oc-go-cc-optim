...
See [configs/config.oc-go-cc.json](configs/config.oc-go-cc.json) for the complete annotated proxy configuration example.

For Claude Code configuration, see [configs/config.cc.json](configs/config.cc.json).
